...
src/
  ...
  *.test.ts           เทสต์ policy, browser-queue, session-registry, recurrence, scheduler, skills, bot (npm test)
...
npm test               # เทสต์ policy, คิว browser, ทะเบียน session, recurrence, scheduler, skills, bot (เร็ว ไม่ใช้โควต้า)
